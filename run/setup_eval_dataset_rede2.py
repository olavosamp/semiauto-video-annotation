...
/home/common/flexiveis/datasets/limpo_nao_limpo/
'''
'''
...
remoteDatasetPath   = Path("/home/common/flexiveis/datasets/limpo_nao_limpo/")
...
# videoList = []
# for img in imageListVal:
#     img = str(Path(img).relative_to(remoteDatasetPath / "val").name)
#     for ext in commons.videoFormats:
#         extPos = img.find(ext)
#         if extPos != -1:
#             videoList.append(img[:extPos+3])
#             # print(img[:extPos+4])
# for video in set(videoList):
#     print(video)

# exit()
# Get reference dataset validation video list
# videoList = commons.val_videos_reference_dataset_rede_2
# hashList = []
...
hashList = commons.val_videos_reference_dataset_rede_2_hashes
