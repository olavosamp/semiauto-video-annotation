...
trainPath           = Path(dirs.iter_folder) / "rede_{}_train_dataset.csv".format(rede)
valPath             = Path(dirs.iter_folder) / "rede_{}_val_dataset.csv".format(rede)
...
dutils.move_to_class_folders(trainPath, semiautoDatasetPath / "train", target_net=netName,
                                    target_class=None, move=True)

dutils.copy_dataset_to_folder(valPath, semiautoDatasetPath / "val", path_column="FramePath")
dutils.move_to_class_folders(valPath, semiautoDatasetPath / "val", target_net=netName,
                                    target_class=None, move=True)